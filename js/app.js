...
(function(angular) {
    ...
    var language = (typeof defaultConfig.language != 'undefined')?defaultConfig.language.substring(0, 2).toLowerCase(): 'en';
    ...
    angular.module('SmartMirror', ['ngAnimate', 'tmh.dynamicLocale', 'pascalprecht.translate'])
        ...
        .config(['$translateProvider', function ($translateProvider) {
            ...
            var language = (typeof defaultConfig.language != 'undefined')?defaultConfig.language.substring(0, 2): 'en';
